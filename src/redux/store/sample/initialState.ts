...
export const samples: { [sampleID: string]: ISample } = {
  ...
  "f57d9727-d7f0-4027-b9cd-fb7b56a79df4": {
    ...
    filename: "RS.WAV",
    url:
      "https://raw.githubusercontent.com/glimberger/react-redux-sequencer/gh-pages/sounds/f57d9727-d7f0-4027-b9cd-fb7b56a79df4.wav",
    label: "TR808 - RS",
    type: "audio/wave"
  },
